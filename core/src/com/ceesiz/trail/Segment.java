...
public class Segment {
    ...
    public Segment(Trail trail, int index, float x, float y, float lerp, float length, float width, Vector2 direction, Color color) {
        this.trail = trail;
        this.index = index;
    ...
    public Segment(Trail trail, int index, float ax, float ay, float bx, float by, float lerp, float length, float width, Vector2 direction, Color color) {
        this.trail = trail;
        this.index = index;
        this.a.set(ax, ay);
        this.b.set(bx, by);
    ...
    public void lerp(Vector2 targetDirection, boolean firstSegment) {
        ...
        if (firstSegment) {
            ...
            this.crs.setLength(width * 0.75f);
            ...
            this.crs.setLength(width * 0.25f);
            c.set(b.x, b.y);
            c.add(direction);
            c.add(crs);
    ...
    public void lerp(Vector2 targetDirection, Vector2 pC, Vector2 pD, boolean firstSegment) {
        this.direction.lerp(targetDirection, lerp);
        this.crs.set(direction.nor()).rotateDeg(90);
        this.direction.setLength(length);
        this.crs.setLength(width);
